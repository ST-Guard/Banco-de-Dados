...
INSERT INTO usuario (nome, email, cpf, telefone, senha, status, fkPapel) VALUES
	('Carlos Gestor', 'gestor@smartdata.com', '11111111111', '(11) 9999-8888', '123456', 'Ativo', 1),
	('Ana Analista', 'analista@smartdata.com', '22222222222', '(11) 9999-7777', '123456', 'Ativo', 2),
	('Miguel Analista', 'analista@smartdata.com', '22222222222', '(11) 9999-6666', '123456', 'Ativo', 2);
...
SELECT idUsuario, nome, email, fkPapel FROM usuario;